...
# now we create our Trajectory object and alter some method parameters via the keyword arguments
    S = ControlSystem(f, a, b, xa, xb, ua, ub, su=20, sx=10, kx=3, use_chains=False, k=par, first_guess=first_guess, sol_steps=100, dt_sim = 0.01,  maxIt=2)  # k must be a list,  k=par,
