...
# now we create our Trajectory object and alter some method parameters via the keyword arguments
    S = ControlSystem(f, a, b, xa, xb, ua, ub,su=3, sx=3, kx=2, use_chains=False, k=par, sol_steps=100, dt_sim = 0.01, first_guess=first_guess, maxIt=4)  # k must be a list,  k=par,
