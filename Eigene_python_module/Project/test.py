...
constraints = {1: [0.0, 0.65]}
# now we create our Trajectory object and alter some method parameters via the keyword arguments
S = ControlSystem(f, a, b, xa, xb, ua, ub, use_chains=False, k=par[0])  # , constraints=constraints

# first_guess = {'seed':0.2}
S.set_param('sx', 1)
S.set_param('su', 1)
S.set_param('kx', 2)
# S.set_param('first_guess',first_guess)
# S.set_param('k',1.5)
# time to run the iteration
x, u, k = S.solve()
print ('x1 = {}, x2 = {}, u = {}, k = {}'.format(x(1)[0], x(0.5)[1], u(1)[0], k))
...
#                  plotsys=[(0,'x1'), (1,'x2')], plotinputs=[(0,'u')])
#
