...
class Spline(object):
    ...
    def __init__(self, a=0.0, b=1.0, n=5, bv={},
        ...
        self._coeffs = sp.symarray('c'+tag, (self.n, 4))  ##:: array([[cxi_0_0, cxi_0_1, cxi_0_2, cxi_0_3],...,[cxi_9_0, cxi_9_1, cxi_9_2, cxi_9_3]])
        ...
        for i in xrange(self.n):
            ...
            self._P[i] = np.poly1d(self._coeffs[i]) ##:: self._P={0: poly1d([cxi_0_0, cxi_0_1, cxi_0_2, cxi_0_3], dtype=object),{1:cxi_1_0,...},{9:...}}, to here _P is only for one state!!
...
def make_smooth_C2(S):
    ...
    b = sorted(list(b_set), key = lambda c: c.name) ##:: type(b) = list
