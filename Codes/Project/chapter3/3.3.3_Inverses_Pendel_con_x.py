# translation of the inverted pendulum mit der Beschränkung von x
...
S = ControlSystem(f, a, b, xa, xb, ua, ub, su=2, sx=2, kx=2, use_chains=False, maxIt=10, constraints=con, k=par, dt_sim=0.001) #constraints=con,
