...
# Reale Überführungszeit mit unterschiedlichen Anfangswerte von den freien Parameter cf
...
Save_in_Excel = True
path = 'E:\Yifan_Xue\DA\Data\Doppelintegrator_time'
if 1:
    if Save_in_Excel:
        import xlwt
        ...
        workbook.save(path + '\\first_guess_time.xls')
